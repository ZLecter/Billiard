...
Shader "Shader Forge/Custom" {
    Properties {
        ...
        _FresnelHardeness ("Fresnel Hardeness", Range(1, 5)) = 5
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform float _FresnelHardeness;
            struct VertexInput {
...
////// Emissive:
                ...
                float3 emissive = ((_FresnelColor.rgb*lerp((-1.0),_FresnelHardeness,pow(1.0-max(0,dot(normalDirection, viewDirection)),1.0)))*(node_544*UNITY_LIGHTMODEL_AMBIENT.rgb));
